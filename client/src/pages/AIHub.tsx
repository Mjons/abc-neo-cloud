    ...
    <div className="min-h-screen">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button size="lg" className="text-base px-8" asChild>
                <a href="mailto:investors@exoaineocloud.com">Request Demo</a>
              </Button>
            ...
            <Card className="bg-gradient-to-br from-cyan-500/10 to-purple-500/10 border-cyan-500/20">
              <CardContent className="pt-6">
                <p className="text-muted-foreground mb-4">
                  By offering a unified solution for the entire machine learning lifecycle, EXOAI AI Hub enables organizations to accelerate innovation, ensure security, and optimize operational efficiency.
                </p>
      ...
      <section className="py-20">
        <div className="container">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Why EXOAI AI Hub</h2>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="text-left py-4 px-4 text-sm font-semibold text-primary">EXOAI AI Hub</th>
